...
public class EllipticCylinder extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public EllipticCylinder(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint,
...
//    }
    ...
    public void createEllipticCylinder(){
        vertices.clear();
        ArrayList<Vector3f> temp = new ArrayList<>();
